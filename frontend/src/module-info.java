module MasterPlan {
    ...
    opens ui.util.dialogue.category           to javafx.graphics, javafx.controls, javafx.fxml;
    opens ui.util.dialogue.task               to javafx.graphics, javafx.controls, javafx.fxml;
